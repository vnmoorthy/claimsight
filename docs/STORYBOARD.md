...
| 1:05 | app | Narrate the trace as the lamps light: "Order found. Policy loaded. Memories.ai sees a white ceramic mug with a chip on the rim at three seconds. No matching footage elsewhere. Twenty-four dollars is under the seventy-five dollar auto-approve limit, so it executes the refund. Transaction id, done." | Point at the Decision trace panel, then the Decision Card. |
...
| 1:45 | app | "Image search across every prior claim finds the twin at ninety-one percent similarity. The claim is frozen and escalated. The manager gets it in Slack through the WorkBuddy Refund Desk, and here in the desk." | Switch to Refund Desk, open the pending claim, press Deny claim. |
